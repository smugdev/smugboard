...
var siteBoardCreateHeader = '<header><h1>Board Creation</h1></header>';
...
var siteAddHeader = '<header><h1>Board Registration</h1></header>';
...
var settingsPage = '<header><h1>Local Settings</h1></header>';

/* Site HTML (Board list) */

var siteBoardlistHeader = '<header><h1>Smugchan</h1></header>';

var siteBoardlist = '<table id=\'boardlist-table\'></table>';

/* Mod stuff */

var optionsHeader = '<header><h1>Mod Management</h1></header>';
